...
camera.position.z = 6
// Initial position adjustments will happen in scroll logic
...
// --- OBJECTS (The "Product") ---
// Group to hold our product parts
...
// We'll animate the timeline based on scroll position

const sectionDuration = 1 / 4 // 4 sections approx
...
// Timeline Steps
// 1. Initial -> Section 2 (Right aligned text, object moves left)
...
// 2. Section 2 -> Section 3 (Left aligned text, object moves right, zooms in)
...
// 3. Section 3 -> Section 4 (Center text, object center, explosion/expand effect)
